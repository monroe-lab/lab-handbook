---
type: protocol
title: "Working Alone in the Laboratory SOP"
---

# Working Alone in the Laboratory SOP
...
**Source:** [Google Drive](https://drive.google.com/file/d/1crt3ei3MLFNEeWZIeqNi_3-LNDZlF2xf/view)
...
6.  Inspect all equipment and experimental setups prior to use; and
...
The following are also required for working alone in a laboratory:

8.  Minors (*i.e.*, under age 18) are not allowed to work alone in the laboratory;

9.  Mobile contact information (*e.g*, PI/Laboratory Supervisor, Department Safety Coordinator, Laboratory Manager, Laboratory Safety Coordinator, etc.) must be available to any personnel allowed to work alone in the laboratory in case of emergency. Office phone numbers are not sufficient; and
...
- Prior to **Working Alone in the Laboratory**, laboratory personnel must be trained on the laboratory-specific activity and chemical restrictions that must be followed when working alone.

- Ready access to this SOP must be made available.
