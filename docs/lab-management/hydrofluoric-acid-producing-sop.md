---
type: protocol
title: "Hydrofluoric Acid Producing Chemicals SOP"
---
...
## HAZARD OVERVIEW
Hydrofluoric acid (HF)-producing materials produce HF under common laboratory conditions such as exposure to water or acid. HF is extremely corrosive and can cause deep tissue damage and systemic toxicity. The most widely-known property of HF is its ability to dissolve glass and bone. Hydrofluoric acid also attacks glazes, enamels, pottery, concrete, rubber, leather, and many metals and organic compounds. [SafetyNet #70](http://safetyservices.ucdavis.edu/safetynet/safe-use-hydrofluoric-acid) further describes the health and safety hazards associated with HF use and exposure.
...
4.  Ammonium fluoride (CAS-No.: 12125-01-8): H301 Acute oral toxicity, H331 acute inhalation toxicity, H311 acute dermal toxicity, strong hydrogen fluoride-releaser if burned.

5.  Wesson salt mixture (CAS-No.: mixture): contains sodium fluoride, see below.
...
All work will be done in the chemical fume hood.

## ADMINISTRATIVE CONTROLS
The following elements are required:

1.  Complete the [UC Laboratory Safety Fundamentals](http://safetyservices.ucdavis.edu/tr/lmsL/UCLabsf) (or approved equivalent) training prior to working in the laboratory;
...
9.  Notify the PI and/or Laboratory Supervisor of any accidents, incidents, near-misses, or upset conditions (*e.g.,* unexpected rise or drop in temperature, color or phase change, evolution of gas) involving HF-producing materials described in this SOP.

For HF-producing materials, the following are also required:

10. If working alone with HF-producing materials is allowed by the research group, a [Working Alone SOP](http://safetyservices.ucdavis.edu/sites/default/files/documents/WorkingAlone_SOPtemplate.docx) is required;

11. HF-producing materials must only be used in a room with a properly functioning eye wash. A safety shower must be available within 10 seconds of travel;

12. A supply of calcium gluconate gel **must** be within reach of the user. In addition, a recommended best practice is that a responder (*e.g.*, a person trained on this SOP and [SafetyNet #70](http://safetyservices.ucdavis.edu/safetynet/safe-use-hydrofluoric-acid)) should be within audible and visible range with easy access to calcium gluconate gel to assist in the event of user exposure. The responder **must** wear nitrile or neoprene gloves when administering first aid to avoid secondary contamination;

13. The date the calcium gluconate solution or gel was received should be noted and the expiration date shall be monitored; calcium gluconate expires in 36 months;

14. If a reaction is left unattended, warning signs must be posted on the fume hood with the sash closed;

15. Never exceed the laboratory maximum quantity limit without prior approval from the PI/Laboratory Supervisor;

16. Use a bottle carrier when transporting HF-producing materials between work areas; and
...
A.  Eye Protection: Eye protection is required for all work with HF-producing materials.
    ...
    iii. Ordinary prescription glasses will NOT provide adequate protection unless they also meet the ANSI Z87.1 standard and have compliant side shields.

B.  Body Protection: At a minimum a chemically-compatible laboratory coat that fully extends to the wrist is necessary.

    i.  For chemicals which are corrosive and/or toxic by skin contact/absorption additional protective clothing (*e.g.,* face shield, chemically-resistant apron, disposable sleeves, etc.) are required where splashes or skin contact is foreseeable.

C.  Hand Protection: Hand protection is needed for the activities described in this SOP. Define the type of glove to be used based on the following:

    i.  Chemical(s) being used;

    ii. Anticipated chemical contact (e.g. incidental, immersion, etc.);

    iii. Manufacturers' permeation/compatibility data; and

    iv. Whether a combination of different gloves is needed for any specific procedural step or task.

Neoprene or nitrile rubber gloves are best for working with HF-producing material. When handling large quantities of HF-producing materials, wear thick neoprene or nitrile rubber gloves with a disposable neoprene or nitrile glove worn under the outer glove. Thick gloves can reduce dexterity, and may increase the risk of spills, however they provide superior protection when the risk of exposure is greater due to the quantity being used or handled. If wearing two layers of thinner neoprene or nitrile disposable gloves, change the outer pair frequently. Gloves should be changed following any contamination and properly disposed of as hazardous waste.
...
- Wear respiratory protection. Avoid breathing vapors, mist or gas.

- If possible, confine the spill to a small area using a spill kit or absorbent material. Use neutralizing agent (sodium carbonate or a slurry of magnesium hydroxide) and liquid binding material (e.g., vermiculite; **Note: Do NOT use sand or kitty litter because HF reacts with silica to produce silicon tetrafluoride, a toxic gas**) to absorb spill.
...
- Prior to using **Hydrofluoric Acid Producing Materials**, laboratory personnel must be trained on the hazards described in this SOP, how to protect themselves from these hazards, and emergency procedures.
