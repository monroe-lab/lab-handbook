---
type: protocol
title: "Make Buffer A (Quick Extraction Buffer)"
---

# Make Buffer A (Quick Extraction Buffer)
...
**Purpose:** Make Buffer A, the alkaline high-salt extraction buffer used in the quick DNA extraction protocol. This is the simplest buffer recipe in the curriculum.

## Time estimate

**Wall time:** ~30 min + autoclave | **Hands-on:** ~20 min
...
|-----------|--------|-------------------|
| Tris base | 1.21 g | 100 mM |
| KCl | 7.46 g | 1 M |
| EDTA disodium salt | 0.372 g | 10 mM |
...
5. Bring to 100 mL with distilled water.
6. Autoclave (liquid cycle) or filter-sterilize. See [[autoclave]].
...
Room temperature. Stable for months.
