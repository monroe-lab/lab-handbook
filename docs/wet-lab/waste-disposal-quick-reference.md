---
type: protocol
title: "Waste Disposal Quick Reference"
---

# Waste Disposal Quick Reference

## Resources

**Related Protocols:** [[lab-orientation]], [[spill-response]], [[sharps-handling]], [[bench-cleanup]]

**Related SOPs:** See `docs/lab-safety/` for full EH&S waste disposal regulations

**Purpose:** Quick-reference for where every type of waste goes. Print this and tape it near the waste area if helpful.
...
**Do NOT mix incompatible chemicals in the same waste bottle.** This can cause reactions, heat, or toxic gas.

| Waste category | What goes in | Keep separate from |
|---------------|-------------|-------------------|
| **Halogenated solvents** | Chloroform, dichloromethane | Non-halogenated solvents |
...
**When is a waste bottle full?**
Fill to the shoulder of the bottle, not to the top. Leave headspace. When full, request pickup from EH&S through Grey.

## Documentation

No separate lab notebook entry needed. But if you are unsure about a waste type, ask Grey before disposing. Getting it wrong is a safety and compliance issue.
