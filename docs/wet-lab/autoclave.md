...
1. Prepare your media in an Erlenmeyer flask (leave room — no more than 2/3 full)
2. Cover flask mouth loosely with **aluminum foil** (not sealed tight — steam must penetrate)
3. Leave **magnetic stir bar** in the flask (saves a step later)
4. If autoclaving water or solutions in bottles, **loosen the cap** (pressure must equalize)
5. Place autoclave tape on the foil/container to confirm sterilization
6. Load into autoclave
7. Select **liquid cycle** (121 C, 30 min)
8. Start the cycle
9. **Do not open** until pressure gauge reads zero and temperature has dropped
10. Remove carefully (contents are hot — use autoclave gloves)
11. Autoclave tape should show dark stripes (indicates it reached temperature)

> *Media looks brown/caramelized after autoclaving:* pH was too high before autoclaving. Sugars undergo Maillard reactions at high pH + high temp. Adjust pH more carefully before autoclaving (target 5.8, not higher).

> *Agar solidified in the flask before you could pour:* You waited too long. Agar sets around 40-45 C. You can re-melt it in a microwave (carefully, in short bursts with swirling) but repeated melting degrades gel strength.

> *Bottle exploded/cracked:* Cap was too tight. Pressure differential between the bottle interior and the autoclave chamber can shatter glass. Always loosen caps.
