...
* 📖 MS salt (Murashige & Skoog basal salt mixture, 4.4 g/L)
...
* ⚙️ Tube Rotator (for seed sterilization)
* ⚙️ pH Meter or pH strips
...
2. Sterilize seeds using one of the methods in 📖 Seed Sterilization:
    * **Small batches (<200 seeds):** 70% EtOH, rotate 10-15 min, then dry in 📖 clean bench
...
4. In the 📖 clean bench, pour \~25 mL per plate
...
* Also plant a set directly in 📖 soil as backup and to learn both methods.
