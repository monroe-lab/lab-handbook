...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/CAEXXX_35/` | SRR32633491 |
...
- SRA run: [SRR32633491](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633491) (sample alias `CAEXXX-35`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/CAEXXX_35/`
