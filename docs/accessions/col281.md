...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_281/` | SRR32633334 |
...
- SRA run: [SRR32633334](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633334) (sample alias `COL281`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_281/`
