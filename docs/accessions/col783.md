...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_783/` | SRR32633543 |
...
- SRA run: [SRR32633543](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633543) (sample alias `COL783`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_783/`
