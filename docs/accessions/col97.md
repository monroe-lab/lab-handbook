...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_97/` | SRR32633401 |
...
- SRA run: [SRR32633401](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633401) (sample alias `COL97`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_97/`
