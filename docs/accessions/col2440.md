...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2440/` | SRR32633441 |
...
- SRA run: [SRR32633441](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633441) (sample alias `COL2440`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2440/`
