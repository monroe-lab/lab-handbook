...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2014/` | SRR32633466 |
...
- SRA run: [SRR32633466](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633466) (sample alias `COL2014`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2014/`
