...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1134/` | SRR32633444 |
...
- SRA run: [SRR32633444](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633444) (sample alias `COL1134`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1134/`
