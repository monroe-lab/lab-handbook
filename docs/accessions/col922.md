...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_922/` | SRR32633524 |
...
- SRA run: [SRR32633524](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633524) (sample alias `COL922`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_922/`
