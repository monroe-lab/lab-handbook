...
type: "accession"
title: "CAEXXX-16"
accession_id: "CAEXXX-16"
project: "Cassava Landraces (New Phytologist 2026)"
people: "[[Kehan Zhao]]"
species: "Manihot caerulescens"
status: "archived"
...
*Manihot caerulescens* (a wild relative of cassava) sequenced for [[Kehan Zhao]]'s 2026 *New Phytologist* paper on Colombian cassava landrace genomic diversity. Wild *Manihot* sample. Directory uses placeholder species code; SRA species: *Manihot caerulescens*.

## Sequencing

| Platform | Run / batch | Farm path | SRA |
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/CAEXXX_16/` | SRR32633566 |
...
- SRA run: [SRR32633566](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633566) (sample alias `CAEXXX-16`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/CAEXXX_16/`
