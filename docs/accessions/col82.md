...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_82/` | SRR32633539 |
...
- SRA run: [SRR32633539](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633539) (sample alias `COL82`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_82/`
