...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_267/` | SRR32633279 |
...
- SRA run: [SRR32633279](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633279) (sample alias `COL267`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_267/`
