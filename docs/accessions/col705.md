...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_705/` | SRR32633216 |
...
- SRA run: [SRR32633216](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633216) (sample alias `COL705`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_705/`
