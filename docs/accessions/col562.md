...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_562/` | SRR32633227 |
...
- SRA run: [SRR32633227](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633227) (sample alias `COL562`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_562/`
