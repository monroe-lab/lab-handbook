...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2251/` | SRR32633447 |
...
- SRA run: [SRR32633447](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633447) (sample alias `COL2251`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2251/`
