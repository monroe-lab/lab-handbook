...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_304/` | SRR32633328 |
...
- SRA run: [SRR32633328](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633328) (sample alias `COL304`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_304/`
