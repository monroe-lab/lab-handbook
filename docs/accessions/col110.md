...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_110/` | SRR32633464 |
...
- SRA run: [SRR32633464](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633464) (sample alias `COL110`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_110/`
