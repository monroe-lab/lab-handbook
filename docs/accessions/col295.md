...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_295/` | SRR32633331 |
...
- SRA run: [SRR32633331](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633331) (sample alias `COL295`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_295/`
