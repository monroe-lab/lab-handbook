...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_163/` | SRR32633365 |
...
- SRA run: [SRR32633365](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633365) (sample alias `COL163`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_163/`
