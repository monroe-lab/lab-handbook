...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_608/` | SRR32633287 |
...
- SRA run: [SRR32633287](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633287) (sample alias `COL608`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_608/`
