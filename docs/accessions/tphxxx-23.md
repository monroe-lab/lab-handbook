...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_23/` | SRR32633489 |
...
- SRA run: [SRR32633489](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633489) (sample alias `TPHXXX-23`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_23/`
