...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2255/` | SRR32633244 |
...
- SRA run: [SRR32633244](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633244) (sample alias `COL2255`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2255/`
