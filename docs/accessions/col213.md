...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_213/` | SRR32633382 |
...
- SRA run: [SRR32633382](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633382) (sample alias `COL213`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_213/`
