...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_89/` | SRR32633402 |
...
- SRA run: [SRR32633402](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633402) (sample alias `COL89`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_89/`
