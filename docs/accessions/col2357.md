...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2357/` | SRR32633420 |
...
- SRA run: [SRR32633420](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633420) (sample alias `COL2357`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2357/`
