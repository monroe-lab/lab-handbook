...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1752/` | SRR32633371 |
...
- SRA run: [SRR32633371](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633371) (sample alias `COL1752`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1752/`
