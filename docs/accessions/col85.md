...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_85/` | SRR32633535 |
...
- SRA run: [SRR32633535](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633535) (sample alias `COL85`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_85/`
