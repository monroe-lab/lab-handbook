...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1640/` | SRR32633364 |
...
- SRA run: [SRR32633364](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633364) (sample alias `COL1640`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1640/`
