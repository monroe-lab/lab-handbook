...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1082/` | SRR32633308 |
...
- SRA run: [SRR32633308](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633308) (sample alias `COL1082`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1082/`
