...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1050/` | SRR32633312 |
...
- SRA run: [SRR32633312](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633312) (sample alias `COL1050`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1050/`
