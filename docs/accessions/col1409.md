...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1409/` | SRR32633494 |
...
- SRA run: [SRR32633494](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633494) (sample alias `COL1409`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1409/`
