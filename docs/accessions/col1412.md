...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1412/` | SRR32633483 |
...
- SRA run: [SRR32633483](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633483) (sample alias `COL1412`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1412/`
