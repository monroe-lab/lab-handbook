...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1542/` | SRR32633210 |
...
- SRA run: [SRR32633210](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633210) (sample alias `COL1542`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1542/`
