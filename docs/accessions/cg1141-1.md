...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/CG_1141_1/` | SRR32633373 |
...
- SRA run: [SRR32633373](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633373) (sample alias `CG1141-1`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/CG_1141_1/`
