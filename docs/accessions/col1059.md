...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1059/` | SRR32633314 |
...
- SRA run: [SRR32633314](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633314) (sample alias `COL1059`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1059/`
