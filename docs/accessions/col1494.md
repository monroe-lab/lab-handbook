...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1494/` | SRR32633558 |
...
- SRA run: [SRR32633558](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633558) (sample alias `COL1494`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1494/`
