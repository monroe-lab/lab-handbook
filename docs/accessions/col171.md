...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_171/` | SRR32633357 |
...
- SRA run: [SRR32633357](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633357) (sample alias `COL171`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_171/`
