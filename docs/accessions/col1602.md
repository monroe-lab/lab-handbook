...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1602/` | SRR32633367 |
...
- SRA run: [SRR32633367](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633367) (sample alias `COL1602`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1602/`
