...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2181/` | SRR32633372 |
...
- SRA run: [SRR32633372](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633372) (sample alias `COL2181`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2181/`
