...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1524/` | SRR32633551 |
...
- SRA run: [SRR32633551](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633551) (sample alias `COL1524`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1524/`
