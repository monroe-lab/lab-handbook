...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1759/` | SRR32633355 |
...
- SRA run: [SRR32633355](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633355) (sample alias `COL1759`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1759/`
