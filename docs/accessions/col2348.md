...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2348/` | SRR32633394 |
...
- SRA run: [SRR32633394](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633394) (sample alias `COL2348`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2348/`
