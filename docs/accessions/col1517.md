...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1517/` | SRR32633554 |
...
- SRA run: [SRR32633554](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633554) (sample alias `COL1517`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1517/`
