...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1604/` | SRR32633208 |
...
- SRA run: [SRR32633208](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633208) (sample alias `COL1604`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1604/`
