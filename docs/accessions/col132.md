...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_132/` | SRR32633509 |
...
- SRA run: [SRR32633509](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633509) (sample alias `COL132`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_132/`
