...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_319/` | SRR32633322 |
...
- SRA run: [SRR32633322](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633322) (sample alias `COL319`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_319/`
