...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/COL_670A/` | SRR32633264 |
...
- SRA run: [SRR32633264](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633264) (sample alias `COL670A`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/COL_670A/`
