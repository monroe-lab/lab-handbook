...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_442/` | SRR32633234 |
...
- SRA run: [SRR32633234](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633234) (sample alias `COL442`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_442/`
