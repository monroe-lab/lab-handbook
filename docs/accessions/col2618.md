...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2618/` | SRR32633424 |
...
- SRA run: [SRR32633424](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633424) (sample alias `COL2618`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2618/`
