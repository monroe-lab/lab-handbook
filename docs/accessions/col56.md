...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_56/` | SRR32633224 |
...
- SRA run: [SRR32633224](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633224) (sample alias `COL56`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_56/`
