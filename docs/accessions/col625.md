...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_625/` | SRR32633400 |
...
- SRA run: [SRR32633400](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633400) (sample alias `COL625`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_625/`
