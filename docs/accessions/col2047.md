...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2047/` | SRR32633197 |
...
- SRA run: [SRR32633197](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633197) (sample alias `COL2047`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2047/`
