...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1945/` | SRR32633469 |
...
- SRA run: [SRR32633469](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633469) (sample alias `COL1945`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1945/`
