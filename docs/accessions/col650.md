...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_650/` | SRR32633515 |
...
- SRA run: [SRR32633515](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633515) (sample alias `COL650`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_650/`
