...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1490/` | SRR32633559 |
...
- SRA run: [SRR32633559](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633559) (sample alias `COL1490`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1490/`
