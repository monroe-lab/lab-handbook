...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1724/` | SRR32633356 |
...
- SRA run: [SRR32633356](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633356) (sample alias `COL1724`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1724/`
