...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_20/` | SRR32633487 |
...
- SRA run: [SRR32633487](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633487) (sample alias `TPHXXX-20`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_20/`
