...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_869/` | SRR32633532 |
...
- SRA run: [SRR32633532](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633532) (sample alias `COL869`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_869/`
