...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1366/` | SRR32633387 |
...
- SRA run: [SRR32633387](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633387) (sample alias `COL1366`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1366/`
