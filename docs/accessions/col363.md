...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_363/` | SRR32633239 |
...
- SRA run: [SRR32633239](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633239) (sample alias `COL363`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_363/`
