...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1570/` | SRR32633209 |
...
- SRA run: [SRR32633209](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633209) (sample alias `COL1570`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1570/`
