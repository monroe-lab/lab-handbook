...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2694/` | SRR32633383 |
...
- SRA run: [SRR32633383](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633383) (sample alias `COL2694`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2694/`
