...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1413/` | SRR32633301 |
...
- SRA run: [SRR32633301](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633301) (sample alias `COL1413`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1413/`
