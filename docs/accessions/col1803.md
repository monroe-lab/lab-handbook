...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1803/` | SRR32633352 |
...
- SRA run: [SRR32633352](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633352) (sample alias `COL1803`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1803/`
