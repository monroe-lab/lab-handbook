...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1523/` | SRR32633553 |
...
- SRA run: [SRR32633553](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633553) (sample alias `COL1523`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1523/`
