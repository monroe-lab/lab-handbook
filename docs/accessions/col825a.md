...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_825A/` | SRR32633502 |
...
- SRA run: [SRR32633502](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633502) (sample alias `COL825A`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_825A/`
