...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2059/` | SRR32633194 |
...
- SRA run: [SRR32633194](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633194) (sample alias `COL2059`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2059/`
