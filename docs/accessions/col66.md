...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/COL_66/` | SRR32633272 |
...
- SRA run: [SRR32633272](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633272) (sample alias `COL66`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/COL_66/`
