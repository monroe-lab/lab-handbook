...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1667/` | SRR32633203 |
...
- SRA run: [SRR32633203](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633203) (sample alias `COL1667`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1667/`
