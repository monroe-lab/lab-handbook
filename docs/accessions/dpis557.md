...
status: "archived"
status_note: "Whole-genome sequenced at Wolfskill (Brown lab); legacy ID `DPIS557` has no WPI field-grid mapping."
priority: "1"
...
| --- | --- | --- | --- |
| Illumina WGS | `Pvera_Kerman_RefGen_v1` | `DPIS557` | `/group/gmonroegrp2/chaehee/pistachio/wgs_wolfskill/` |
