...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_126/` | SRR32633405 |
...
- SRA run: [SRR32633405](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633405) (sample alias `COL126`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_126/`
