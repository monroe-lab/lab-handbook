...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_588/` | SRR32633221 |
...
- SRA run: [SRR32633221](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633221) (sample alias `COL588`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_588/`
