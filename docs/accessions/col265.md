...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_265/` | SRR32633415 |
...
- SRA run: [SRR32633415](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633415) (sample alias `COL265`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_265/`
