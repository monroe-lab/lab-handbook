...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_130/` | SRR32633304 |
...
- SRA run: [SRR32633304](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633304) (sample alias `COL130`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_130/`
