...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_23/` | SRR32633488 |
...
- SRA run: [SRR32633488](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633488) (sample alias `TSTXXX-23`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_23/`
