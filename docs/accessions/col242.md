...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_242/` | SRR32633442 |
...
- SRA run: [SRR32633442](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633442) (sample alias `COL242`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_242/`
