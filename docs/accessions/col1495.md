...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1495/` | SRR32633557 |
...
- SRA run: [SRR32633557](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633557) (sample alias `COL1495`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1495/`
