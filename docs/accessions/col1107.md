...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1107/` | SRR32633350 |
...
- SRA run: [SRR32633350](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633350) (sample alias `COL1107`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1107/`
