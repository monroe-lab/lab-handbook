...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1005/` | SRR32633315 |
...
- SRA run: [SRR32633315](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633315) (sample alias `COL1005`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1005/`
