...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2238/` | SRR32633448 |
...
- SRA run: [SRR32633448](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633448) (sample alias `COL2238`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2238/`
