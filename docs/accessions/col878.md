...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_878/` | SRR32633531 |
...
- SRA run: [SRR32633531](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633531) (sample alias `COL878`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_878/`
