...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_287/` | SRR32633332 |
...
- SRA run: [SRR32633332](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633332) (sample alias `COL287`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_287/`
