...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1361/` | SRR32633285 |
...
- SRA run: [SRR32633285](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633285) (sample alias `COL1361`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1361/`
