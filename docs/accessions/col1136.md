...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1136/` | SRR32633433 |
...
- SRA run: [SRR32633433](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633433) (sample alias `COL1136`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1136/`
