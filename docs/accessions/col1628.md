...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1628/` | SRR32633207 |
...
- SRA run: [SRR32633207](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633207) (sample alias `COL1628`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1628/`
