...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2635/` | SRR32633343 |
...
- SRA run: [SRR32633343](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633343) (sample alias `COL2635`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2635/`
