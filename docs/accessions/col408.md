...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_408/` | SRR32633236 |
...
- SRA run: [SRR32633236](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633236) (sample alias `COL408`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_408/`
