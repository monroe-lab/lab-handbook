...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2542/` | SRR32633418 |
...
- SRA run: [SRR32633418](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633418) (sample alias `COL2542`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2542/`
