...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_337/` | SRR32633240 |
...
- SRA run: [SRR32633240](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633240) (sample alias `COL337`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_337/`
