...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2627/` | SRR32633345 |
...
- SRA run: [SRR32633345](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633345) (sample alias `COL2627`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2627/`
