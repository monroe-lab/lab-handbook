...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_296/` | SRR32633330 |
...
- SRA run: [SRR32633330](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633330) (sample alias `COL296`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_296/`
