...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1459/` | SRR32633564 |
...
- SRA run: [SRR32633564](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633564) (sample alias `COL1459`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1459/`
