...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_948C/` | SRR32633319 |
...
- SRA run: [SRR32633319](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633319) (sample alias `COL948C`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_948C/`
