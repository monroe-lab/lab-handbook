...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_880/` | SRR32633529 |
...
- SRA run: [SRR32633529](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633529) (sample alias `COL880`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_880/`
