...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1477/` | SRR32633299 |
...
- SRA run: [SRR32633299](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633299) (sample alias `COL1477`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1477/`
