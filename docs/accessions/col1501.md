...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1501/` | SRR32633556 |
...
- SRA run: [SRR32633556](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633556) (sample alias `COL1501`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1501/`
