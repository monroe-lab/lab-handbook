...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1236/` | SRR32633416 |
...
- SRA run: [SRR32633416](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633416) (sample alias `COL1236`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1236/`
