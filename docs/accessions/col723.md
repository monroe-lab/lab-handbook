...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_723/` | SRR32633550 |
...
- SRA run: [SRR32633550](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633550) (sample alias `COL723`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_723/`
