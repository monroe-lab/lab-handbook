...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2256/` | SRR32633243 |
...
- SRA run: [SRR32633243](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633243) (sample alias `COL2256`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2256/`
