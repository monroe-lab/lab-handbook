...
*Pistacia vera* accession from [[Patrick J Brown]]'s diversity collection at the UC Davis Wolfskill Experimental Orchard (Winters, CA). Pat Brown breeding-line code (Wolfskill block B, row 2, tree 27).
