...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1480/` | SRR32633298 |
...
- SRA run: [SRR32633298](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633298) (sample alias `COL1480`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1480/`
