...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/COL_1288/` | SRR32633477 |
...
- SRA run: [SRR32633477](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633477) (sample alias `COL1288`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/COL_1288/`
