...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_272/` | SRR32633338 |
...
- SRA run: [SRR32633338](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633338) (sample alias `COL272`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_272/`
