...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_308/` | SRR32633327 |
...
- SRA run: [SRR32633327](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633327) (sample alias `COL308`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_308/`
