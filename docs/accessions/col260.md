...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_260/` | SRR32633425 |
...
- SRA run: [SRR32633425](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633425) (sample alias `COL260`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_260/`
