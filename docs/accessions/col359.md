...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_359/` | SRR32633410 |
...
- SRA run: [SRR32633410](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633410) (sample alias `COL359`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_359/`
