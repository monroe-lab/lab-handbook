...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_269/` | SRR32633342 |
...
- SRA run: [SRR32633342](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633342) (sample alias `COL269`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_269/`
