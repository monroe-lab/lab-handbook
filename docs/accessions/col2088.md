...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2088/` | SRR32633459 |
...
- SRA run: [SRR32633459](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633459) (sample alias `COL2088`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2088/`
