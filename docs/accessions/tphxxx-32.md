...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_32/` | SRR32633480 |
...
- SRA run: [SRR32633480](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633480) (sample alias `TPHXXX-32`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_32/`
