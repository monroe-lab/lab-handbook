...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_818/` | SRR32633541 |
...
- SRA run: [SRR32633541](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633541) (sample alias `COL818`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_818/`
