...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1326/` | SRR32633520 |
...
- SRA run: [SRR32633520](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633520) (sample alias `COL1326`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1326/`
