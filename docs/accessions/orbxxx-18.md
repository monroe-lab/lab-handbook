...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ORBXXX_18/` | SRR32633498 |
...
- SRA run: [SRR32633498](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633498) (sample alias `ORBXXX-18`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ORBXXX_18/`
