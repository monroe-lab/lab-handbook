...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1033/` | SRR32633445 |
...
- SRA run: [SRR32633445](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633445) (sample alias `COL1033`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1033/`
