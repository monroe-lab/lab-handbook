...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_327/` | SRR32633411 |
...
- SRA run: [SRR32633411](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633411) (sample alias `COL327`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_327/`
