...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1147/` | SRR32633324 |
...
- SRA run: [SRR32633324](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633324) (sample alias `COL1147`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1147/`
