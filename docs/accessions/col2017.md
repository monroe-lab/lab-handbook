...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2017/` | SRR32633465 |
...
- SRA run: [SRR32633465](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633465) (sample alias `COL2017`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2017/`
