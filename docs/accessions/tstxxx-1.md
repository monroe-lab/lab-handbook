...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_1/` | SRR32633257 |
...
- SRA run: [SRR32633257](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633257) (sample alias `TSTXXX-1`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_1/`
