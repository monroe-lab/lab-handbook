...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_618/` | SRR32633217 |
...
- SRA run: [SRR32633217](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633217) (sample alias `COL618`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_618/`
