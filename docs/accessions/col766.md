...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_766/` | SRR32633548 |
...
- SRA run: [SRR32633548](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633548) (sample alias `COL766`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_766/`
