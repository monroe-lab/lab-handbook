...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_393/` | SRR32633237 |
...
- SRA run: [SRR32633237](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633237) (sample alias `COL393`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_393/`
