...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1065/` | SRR32633563 |
...
- SRA run: [SRR32633563](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633563) (sample alias `COL1065`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1065/`
