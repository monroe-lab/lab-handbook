...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1430/` | SRR32633572 |
...
- SRA run: [SRR32633572](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633572) (sample alias `COL1430`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1430/`
