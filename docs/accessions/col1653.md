...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1653/` | SRR32633363 |
...
- SRA run: [SRR32633363](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633363) (sample alias `COL1653`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1653/`
