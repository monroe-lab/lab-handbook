...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1505/` | SRR32633378 |
...
- SRA run: [SRR32633378](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633378) (sample alias `COL1505`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1505/`
