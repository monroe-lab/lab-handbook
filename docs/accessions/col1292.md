...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1292/` | SRR32633305 |
...
- SRA run: [SRR32633305](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633305) (sample alias `COL1292`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1292/`
