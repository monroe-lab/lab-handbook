...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_87/` | SRR32633530 |
...
- SRA run: [SRR32633530](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633530) (sample alias `COL87`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_87/`
