...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2043/` | SRR32633462 |
...
- SRA run: [SRR32633462](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633462) (sample alias `COL2043`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2043/`
