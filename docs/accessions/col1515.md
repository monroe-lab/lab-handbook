...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1515/` | SRR32633555 |
...
- SRA run: [SRR32633555](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633555) (sample alias `COL1515`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1515/`
