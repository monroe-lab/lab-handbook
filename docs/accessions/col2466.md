...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2466/` | SRR32633438 |
...
- SRA run: [SRR32633438](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633438) (sample alias `COL2466`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2466/`
