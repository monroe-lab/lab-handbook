...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1541/` | SRR32633369 |
...
- SRA run: [SRR32633369](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633369) (sample alias `COL1541`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1541/`
