...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1129/` | SRR32633306 |
...
- SRA run: [SRR32633306](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633306) (sample alias `COL1129`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1129/`
