...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_116/` | SRR32633547 |
...
- SRA run: [SRR32633547](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633547) (sample alias `COL116`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_116/`
