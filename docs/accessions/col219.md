...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_219/` | SRR32633385 |
...
- SRA run: [SRR32633385](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633385) (sample alias `COL219`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_219/`
