...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1784/` | SRR32633199 |
...
- SRA run: [SRR32633199](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633199) (sample alias `COL1784`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1784/`
