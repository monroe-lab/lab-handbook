...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1112A/` | SRR32633453 |
...
- SRA run: [SRR32633453](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633453) (sample alias `COL1112A`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1112A/`
