...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2205/` | SRR32633454 |
...
- SRA run: [SRR32633454](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633454) (sample alias `COL2205`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2205/`
