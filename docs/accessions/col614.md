...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_614/` | SRR32633504 |
...
- SRA run: [SRR32633504](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633504) (sample alias `COL614`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_614/`
