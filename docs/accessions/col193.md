...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_193/` | SRR32633470 |
...
- SRA run: [SRR32633470](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633470) (sample alias `COL193`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_193/`
