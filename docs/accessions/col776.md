...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_776/` | SRR32633544 |
...
- SRA run: [SRR32633544](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633544) (sample alias `COL776`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_776/`
