...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2214/` | SRR32633452 |
...
- SRA run: [SRR32633452](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633452) (sample alias `COL2214`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2214/`
