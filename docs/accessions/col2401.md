...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2401/` | SRR32633443 |
...
- SRA run: [SRR32633443](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633443) (sample alias `COL2401`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2401/`
