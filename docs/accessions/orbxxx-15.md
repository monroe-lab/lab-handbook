...
type: "accession"
title: "ORBXXX-15"
accession_id: "ORBXXX-15"
project: "Cassava Landraces (New Phytologist 2026)"
people: "[[Kehan Zhao]]"
species: "Manihot orbicularis"
status: "archived"
...
*Manihot orbicularis* (a wild relative of cassava) sequenced for [[Kehan Zhao]]'s 2026 *New Phytologist* paper on Colombian cassava landrace genomic diversity. Wild *Manihot* sample. Directory uses placeholder species code; SRA species: *Manihot orbicularis*.

## Sequencing

| Platform | Run / batch | Farm path | SRA |
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ORBXXX_15/` | SRR32633496 |
...
- SRA run: [SRR32633496](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633496) (sample alias `ORBXXX-15`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ORBXXX_15/`
