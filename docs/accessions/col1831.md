...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1831/` | SRR32633348 |
...
- SRA run: [SRR32633348](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633348) (sample alias `COL1831`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1831/`
