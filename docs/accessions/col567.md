...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_567/` | SRR32633226 |
...
- SRA run: [SRR32633226](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633226) (sample alias `COL567`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_567/`
