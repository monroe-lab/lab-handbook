...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_774/` | SRR32633545 |
...
- SRA run: [SRR32633545](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633545) (sample alias `COL774`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_774/`
