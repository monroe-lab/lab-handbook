...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_221/` | SRR32633450 |
...
- SRA run: [SRR32633450](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633450) (sample alias `COL221`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_221/`
