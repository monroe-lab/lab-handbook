...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1228/` | SRR32633300 |
...
- SRA run: [SRR32633300](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633300) (sample alias `COL1228`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1228/`
