...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_431/` | SRR32633235 |
...
- SRA run: [SRR32633235](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633235) (sample alias `COL431`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_431/`
