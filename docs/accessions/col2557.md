...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2557/` | SRR32633429 |
...
- SRA run: [SRR32633429](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633429) (sample alias `COL2557`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2557/`
