...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2629/` | SRR32633344 |
...
- SRA run: [SRR32633344](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633344) (sample alias `COL2629`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2629/`
