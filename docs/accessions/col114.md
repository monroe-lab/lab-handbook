...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_114/` | SRR32633222 |
...
- SRA run: [SRR32633222](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633222) (sample alias `COL114`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_114/`
