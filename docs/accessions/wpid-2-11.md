...
*Pistacia vera* accession from Pat Brown's diversity collection at the UC Davis Wolfskill Experimental Orchard (Winters, CA). Wolfskill orchard block D, row 2, tree 11.
