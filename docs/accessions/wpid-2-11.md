...
type: "accession"
title: "WPID_2_11"
accession_id: "WPID_2_11"
project: "Pistachio Wolfskill Collection"
people: "[[Patrick J Brown]]"
species: "Pistacia vera"
status: "completed"
status_note: "Illumina WGS at Wolfskill (Brown lab); not retained in the 774-sample GBS panel. Legacy WGS ID `DPIS349`."
priority: "1"
...
*Pistacia vera* accession from [[Patrick J Brown]]'s diversity collection at the UC Davis Wolfskill Experimental Orchard (Winters, CA). Wolfskill orchard block D, row 2, tree 11.
...
| --- | --- | --- |
| Illumina WGS | `Pvera_Kerman_RefGen_v1` | `/group/gmonroegrp2/chaehee/pistachio/wgs_wolfskill/` (legacy sample ID `DPIS349`) |
...
- Legacy WGS sample ID: `DPIS349` (in `mapping_sampleID.txt`)
