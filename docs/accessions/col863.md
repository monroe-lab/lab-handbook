...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_863/` | SRR32633534 |
...
- SRA run: [SRR32633534](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633534) (sample alias `COL863`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_863/`
