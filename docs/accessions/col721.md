...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_721/` | SRR32633275 |
...
- SRA run: [SRR32633275](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633275) (sample alias `COL721`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_721/`
