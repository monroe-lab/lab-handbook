...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1052/` | SRR32633274 |
...
- SRA run: [SRR32633274](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633274) (sample alias `COL1052`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1052/`
