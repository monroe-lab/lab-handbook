...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_845B/` | SRR32633537 |
...
- SRA run: [SRR32633537](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633537) (sample alias `COL845B`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_845B/`
