...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_907/` | SRR32633527 |
...
- SRA run: [SRR32633527](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633527) (sample alias `COL907`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_907/`
