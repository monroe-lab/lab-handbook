...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2103/` | SRR32633458 |
...
- SRA run: [SRR32633458](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633458) (sample alias `COL2103`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2103/`
