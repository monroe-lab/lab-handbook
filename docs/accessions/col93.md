...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_93/` | SRR32633503 |
...
- SRA run: [SRR32633503](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633503) (sample alias `COL93`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_93/`
