...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_966D/` | SRR32633316 |
...
- SRA run: [SRR32633316](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633316) (sample alias `COL966D`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_966D/`
