...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_854/` | SRR32633403 |
...
- SRA run: [SRR32633403](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633403) (sample alias `COL854`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_854/`
