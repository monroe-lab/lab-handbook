...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1538/` | SRR32633211 |
...
- SRA run: [SRR32633211](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633211) (sample alias `COL1538`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1538/`
