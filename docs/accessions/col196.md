...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_196/` | SRR32633468 |
...
- SRA run: [SRR32633468](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633468) (sample alias `COL196`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_196/`
