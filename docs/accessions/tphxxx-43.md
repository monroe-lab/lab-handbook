...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_43/` | SRR32633493 |
...
- SRA run: [SRR32633493](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633493) (sample alias `TPHXXX-43`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_43/`
