...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2701/` | SRR32633341 |
...
- SRA run: [SRR32633341](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633341) (sample alias `COL2701`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2701/`
