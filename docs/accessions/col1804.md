...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1804/` | SRR32633393 |
...
- SRA run: [SRR32633393](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633393) (sample alias `COL1804`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1804/`
