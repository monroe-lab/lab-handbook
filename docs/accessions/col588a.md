...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_588A/` | SRR32633291 |
...
- SRA run: [SRR32633291](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633291) (sample alias `COL588A`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_588A/`
