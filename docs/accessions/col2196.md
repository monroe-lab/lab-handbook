...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2196/` | SRR32633192 |
...
- SRA run: [SRR32633192](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633192) (sample alias `COL2196`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2196/`
