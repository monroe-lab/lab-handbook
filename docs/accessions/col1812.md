...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1812/` | SRR32633198 |
...
- SRA run: [SRR32633198](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633198) (sample alias `COL1812`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1812/`
