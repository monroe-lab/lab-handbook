...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_26/` | SRR32633253 |
...
- SRA run: [SRR32633253](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633253) (sample alias `TSTXXX-26`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_26/`
