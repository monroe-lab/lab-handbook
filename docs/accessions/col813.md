...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_813/` | SRR32633542 |
...
- SRA run: [SRR32633542](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633542) (sample alias `COL813`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_813/`
