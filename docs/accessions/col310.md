...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_310/` | SRR32633326 |
...
- SRA run: [SRR32633326](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633326) (sample alias `COL310`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_310/`
