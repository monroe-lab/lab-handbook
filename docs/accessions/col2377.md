...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2377/` | SRR32633389 |
...
- SRA run: [SRR32633389](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633389) (sample alias `COL2377`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2377/`
