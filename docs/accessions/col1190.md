...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1190/` | SRR32633525 |
...
- SRA run: [SRR32633525](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633525) (sample alias `COL1190`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1190/`
