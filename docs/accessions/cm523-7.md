...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/CM_523_7/` | SRR32633399 |
...
- SRA run: [SRR32633399](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633399) (sample alias `CM523-7`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/CM_523_7/`
