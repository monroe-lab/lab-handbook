...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1205/` | SRR32633510 |
...
- SRA run: [SRR32633510](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633510) (sample alias `COL1205`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1205/`
