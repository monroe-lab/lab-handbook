...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_850/` | SRR32633404 |
...
- SRA run: [SRR32633404](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633404) (sample alias `COL850`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_850/`
