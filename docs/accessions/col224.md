...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_224/` | SRR32633422 |
...
- SRA run: [SRR32633422](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633422) (sample alias `COL224`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_224/`
