...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_162/` | SRR32633205 |
...
- SRA run: [SRR32633205](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633205) (sample alias `COL162`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_162/`
