...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_574/` | SRR32633516 |
...
- SRA run: [SRR32633516](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633516) (sample alias `COL574`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_574/`
