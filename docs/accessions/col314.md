...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_314/` | SRR32633277 |
...
- SRA run: [SRR32633277](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633277) (sample alias `COL314`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_314/`
