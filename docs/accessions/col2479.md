...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2479/` | SRR32633436 |
...
- SRA run: [SRR32633436](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633436) (sample alias `COL2479`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2479/`
