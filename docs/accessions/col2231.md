...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2231/` | SRR32633449 |
...
- SRA run: [SRR32633449](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633449) (sample alias `COL2231`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2231/`
