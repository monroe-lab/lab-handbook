...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_169/` | SRR32633360 |
...
- SRA run: [SRR32633360](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633360) (sample alias `COL169`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_169/`
