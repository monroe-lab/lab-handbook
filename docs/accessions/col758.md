...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_758/` | SRR32633549 |
...
- SRA run: [SRR32633549](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633549) (sample alias `COL758`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_758/`
