...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_88/` | SRR32633528 |
...
- SRA run: [SRR32633528](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633528) (sample alias `COL88`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_88/`
