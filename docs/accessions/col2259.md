...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2259/` | SRR32633242 |
...
- SRA run: [SRR32633242](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633242) (sample alias `COL2259`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2259/`
