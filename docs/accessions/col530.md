...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_530/` | SRR32633278 |
...
- SRA run: [SRR32633278](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633278) (sample alias `COL530`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_530/`
