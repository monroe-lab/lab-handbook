...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2524/` | SRR32633434 |
...
- SRA run: [SRR32633434](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633434) (sample alias `COL2524`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2524/`
