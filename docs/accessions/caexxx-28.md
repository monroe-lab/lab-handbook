...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/CAEXXX_28/` | SRR32633571 |
...
- SRA run: [SRR32633571](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633571) (sample alias `CAEXXX-28`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/CAEXXX_28/`
