...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_255/` | SRR32633428 |
...
- SRA run: [SRR32633428](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633428) (sample alias `COL255`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_255/`
