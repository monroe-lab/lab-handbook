...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1429/` | SRR32633251 |
...
- SRA run: [SRR32633251](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633251) (sample alias `COL1429`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1429/`
