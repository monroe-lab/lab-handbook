...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1707/` | SRR32633359 |
...
- SRA run: [SRR32633359](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633359) (sample alias `COL1707`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1707/`
