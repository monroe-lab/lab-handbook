...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2697/` | SRR32633396 |
...
- SRA run: [SRR32633396](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633396) (sample alias `COL2697`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2697/`
