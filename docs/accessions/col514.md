...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_514/` | SRR32633230 |
...
- SRA run: [SRR32633230](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633230) (sample alias `COL514`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_514/`
