...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2617/` | SRR32633417 |
...
- SRA run: [SRR32633417](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633417) (sample alias `COL2617`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2617/`
