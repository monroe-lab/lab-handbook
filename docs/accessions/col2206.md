...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2206/` | SRR32633190 |
...
- SRA run: [SRR32633190](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633190) (sample alias `COL2206`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2206/`
