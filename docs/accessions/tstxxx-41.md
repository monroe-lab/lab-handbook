...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_41/` | SRR32633271 |
...
- SRA run: [SRR32633271](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633271) (sample alias `TSTXXX-41`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_41/`
