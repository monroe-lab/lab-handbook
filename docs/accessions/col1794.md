...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1794/` | SRR32633353 |
...
- SRA run: [SRR32633353](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633353) (sample alias `COL1794`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1794/`
