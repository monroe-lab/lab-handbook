...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_336/` | SRR32633241 |
...
- SRA run: [SRR32633241](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633241) (sample alias `COL336`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_336/`
