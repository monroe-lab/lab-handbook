...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2312/` | SRR32633421 |
...
- SRA run: [SRR32633421](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633421) (sample alias `COL2312`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2312/`
