...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2528/` | SRR32633432 |
...
- SRA run: [SRR32633432](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633432) (sample alias `COL2528`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2528/`
