...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2624/` | SRR32633423 |
...
- SRA run: [SRR32633423](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633423) (sample alias `COL2624`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2624/`
