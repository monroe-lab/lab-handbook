...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_527/` | SRR32633229 |
...
- SRA run: [SRR32633229](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633229) (sample alias `COL527`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_527/`
