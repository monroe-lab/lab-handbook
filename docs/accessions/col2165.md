...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2165/` | SRR32633457 |
...
- SRA run: [SRR32633457](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633457) (sample alias `COL2165`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2165/`
