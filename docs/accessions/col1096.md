...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1096/` | SRR32633307 |
...
- SRA run: [SRR32633307](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633307) (sample alias `COL1096`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1096/`
