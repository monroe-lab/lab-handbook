...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_56/` | SRR32633484 |
...
- SRA run: [SRR32633484](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633484) (sample alias `TPHXXX-56`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_56/`
