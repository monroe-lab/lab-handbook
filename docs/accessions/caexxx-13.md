...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/CAEXXX_13/` | SRR32633570 |
...
- SRA run: [SRR32633570](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633570) (sample alias `CAEXXX-13`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/CAEXXX_13/`
