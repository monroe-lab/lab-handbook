...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_569/` | SRR32633225 |
...
- SRA run: [SRR32633225](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633225) (sample alias `COL569`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_569/`
