...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2252/` | SRR32633245 |
...
- SRA run: [SRR32633245](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633245) (sample alias `COL2252`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2252/`
