...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2177/` | SRR32633455 |
...
- SRA run: [SRR32633455](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633455) (sample alias `COL2177`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2177/`
