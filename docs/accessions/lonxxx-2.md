...
type: "accession"
title: "LONXXX-2"
accession_id: "LONXXX-2"
project: "Cassava Landraces (New Phytologist 2026)"
people: "[[Kehan Zhao]]"
species: "Manihot longipetiolata"
status: "completed"
...
*Manihot longipetiolata* (a wild relative of cassava) sequenced for [[Kehan Zhao]]'s 2026 *New Phytologist* paper on Colombian cassava landrace genomic diversity. Wild *Manihot* sample. Directory uses placeholder species code; SRA species: *Manihot longipetiolata*.

## Sequencing

| Platform | Run / batch | Farm path | SRA |
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/LONXXX_2/` | SRR32633574 |
...
- SRA run: [SRR32633574](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633574) (sample alias `LONXXX-2`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/LONXXX_2/`
