...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2173/` | SRR32633456 |
...
- SRA run: [SRR32633456](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633456) (sample alias `COL2173`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2173/`
