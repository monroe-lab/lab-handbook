...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2704/` | SRR32633414 |
...
- SRA run: [SRR32633414](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633414) (sample alias `COL2704`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2704/`
