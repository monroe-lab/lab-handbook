...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2452/` | SRR32633440 |
...
- SRA run: [SRR32633440](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633440) (sample alias `COL2452`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2452/`
