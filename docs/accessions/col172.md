...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_172/` | SRR32633380 |
...
- SRA run: [SRR32633380](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633380) (sample alias `COL172`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_172/`
