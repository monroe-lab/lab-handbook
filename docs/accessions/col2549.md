...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2549/` | SRR32633430 |
...
- SRA run: [SRR32633430](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633430) (sample alias `COL2549`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2549/`
