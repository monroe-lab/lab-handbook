...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_298/` | SRR32633412 |
...
- SRA run: [SRR32633412](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633412) (sample alias `COL298`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_298/`
