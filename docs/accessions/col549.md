...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_549/` | SRR32633398 |
...
- SRA run: [SRR32633398](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633398) (sample alias `COL549`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_549/`
