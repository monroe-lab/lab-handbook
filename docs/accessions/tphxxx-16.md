...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_16/` | SRR32633481 |
...
- SRA run: [SRR32633481](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633481) (sample alias `TPHXXX-16`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TPHXXX_16/`
