...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_845A/` | SRR32633406 |
...
- SRA run: [SRR32633406](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633406) (sample alias `COL845A`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_845A/`
