...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1424/` | SRR32633262 |
...
- SRA run: [SRR32633262](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633262) (sample alias `COL1424`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1424/`
