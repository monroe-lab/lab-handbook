...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_827/` | SRR32633540 |
...
- SRA run: [SRR32633540](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633540) (sample alias `COL827`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_827/`
