...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1572/` | SRR32633368 |
...
- SRA run: [SRR32633368](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633368) (sample alias `COL1572`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1572/`
