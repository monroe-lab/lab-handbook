...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1820/` | SRR32633349 |
...
- SRA run: [SRR32633349](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633349) (sample alias `COL1820`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1820/`
