...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1931/` | SRR32633471 |
...
- SRA run: [SRR32633471](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633471) (sample alias `COL1931`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1931/`
