...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2007/` | SRR32633467 |
...
- SRA run: [SRR32633467](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633467) (sample alias `COL2007`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2007/`
