...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1156/` | SRR32633518 |
...
- SRA run: [SRR32633518](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633518) (sample alias `COL1156`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1156/`
