...
type: "accession"
title: "WPIA_8_9_2"
accession_id: "WPIA_8_9_2"
project: "Pistachio Wolfskill Collection"
people: "[[Patrick J Brown]]"
species: "Pistacia vera"
status: "completed"
status_note: "Illumina WGS at Wolfskill (Brown lab); not retained in the 774-sample GBS panel. Legacy WGS ID `DPIS220B`."
priority: "1"
...
| --- | --- | --- |
| Illumina WGS | `Pvera_Kerman_RefGen_v1` | `/group/gmonroegrp2/chaehee/pistachio/wgs_wolfskill/` (legacy sample ID `DPIS220B`) |
...
- Legacy WGS sample ID: `DPIS220B` (in `mapping_sampleID.txt`)
