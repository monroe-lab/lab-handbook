...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1468/` | SRR32633388 |
...
- SRA run: [SRR32633388](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633388) (sample alias `COL1468`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_1468/`
