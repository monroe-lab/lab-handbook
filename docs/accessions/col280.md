...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_280/` | SRR32633336 |
...
- SRA run: [SRR32633336](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633336) (sample alias `COL280`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_280/`
