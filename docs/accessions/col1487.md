...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1487/` | SRR32633214 |
...
- SRA run: [SRR32633214](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633214) (sample alias `COL1487`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1487/`
