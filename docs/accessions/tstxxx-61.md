...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_61/` | SRR32633474 |
...
- SRA run: [SRR32633474](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633474) (sample alias `TSTXXX-61`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_61/`
