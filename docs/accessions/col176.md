...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_176/` | SRR32633201 |
...
- SRA run: [SRR32633201](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633201) (sample alias `COL176`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_176/`
