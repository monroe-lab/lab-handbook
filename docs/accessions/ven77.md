...
*Manihot esculenta* (cultivated cassava) sequenced for [[Kehan Zhao]]'s 2026 *New Phytologist* paper on Colombian cassava landrace genomic diversity. Venezuelan accession (CIAT comparison material).

## Sequencing

| Platform | Run / batch | Farm path | SRA |
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/Ven_77/` | SRR32633381 |
...
- SRA run: [SRR32633381](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633381) (sample alias `Ven77`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/Ven_77/`
