...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_956/` | SRR32633318 |
...
- SRA run: [SRR32633318](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633318) (sample alias `COL956`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_956/`
