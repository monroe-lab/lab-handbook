...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL278/` | SRR32633413 |
...
- SRA run: [SRR32633413](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633413) (sample alias `COL278`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL278/`
