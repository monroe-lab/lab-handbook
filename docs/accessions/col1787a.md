...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1787a/` | SRR32633354 |
...
- SRA run: [SRR32633354](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633354) (sample alias `COL1787A`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1787a/`
