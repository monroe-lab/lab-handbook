...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1398/` | SRR32633302 |
...
- SRA run: [SRR32633302](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633302) (sample alias `COL1398`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1398/`
