...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1671/` | SRR32633202 |
...
- SRA run: [SRR32633202](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633202) (sample alias `COL1671`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1671/`
