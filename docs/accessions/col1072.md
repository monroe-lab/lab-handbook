...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1072/` | SRR32633309 |
...
- SRA run: [SRR32633309](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633309) (sample alias `COL1072`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1072/`
