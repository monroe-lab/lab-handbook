...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_2/` | SRR32633492 |
...
- SRA run: [SRR32633492](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633492) (sample alias `TSTXXX-2`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/TSTXXX_2/`
