...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1493/` | SRR32633213 |
...
- SRA run: [SRR32633213](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633213) (sample alias `COL1493`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1493/`
