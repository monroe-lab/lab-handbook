...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_246/` | SRR32633437 |
...
- SRA run: [SRR32633437](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633437) (sample alias `COL246`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_246/`
