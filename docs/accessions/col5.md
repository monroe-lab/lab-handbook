...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_5/` | SRR32633219 |
...
- SRA run: [SRR32633219](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633219) (sample alias `COL5`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_5/`
