...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_318/` | SRR32633323 |
...
- SRA run: [SRR32633323](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633323) (sample alias `COL318`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_318/`
