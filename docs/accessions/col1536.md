...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1536/` | SRR32633370 |
...
- SRA run: [SRR32633370](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633370) (sample alias `COL1536`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1536/`
