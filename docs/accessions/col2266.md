...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2266/` | SRR32633292 |
...
- SRA run: [SRR32633292](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633292) (sample alias `COL2266`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_2266/`
