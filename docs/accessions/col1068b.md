...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1068B/` | SRR32633310 |
...
- SRA run: [SRR32633310](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633310) (sample alias `COL1068B`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1068B/`
