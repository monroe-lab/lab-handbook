...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1062C/` | SRR32633313 |
...
- SRA run: [SRR32633313](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633313) (sample alias `COL1062C`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1062C/`
