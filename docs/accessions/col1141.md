...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1141/` | SRR32633346 |
...
- SRA run: [SRR32633346](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633346) (sample alias `COL1141`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1141/`
