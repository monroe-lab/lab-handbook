...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1485/` | SRR32633561 |
...
- SRA run: [SRR32633561](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633561) (sample alias `COL1485`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1485/`
