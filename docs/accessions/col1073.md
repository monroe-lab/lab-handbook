...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1073/` | SRR32633361 |
...
- SRA run: [SRR32633361](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633361) (sample alias `COL1073`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1073/`
