...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_601/` | SRR32633218 |
...
- SRA run: [SRR32633218](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633218) (sample alias `COL601`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_601/`
