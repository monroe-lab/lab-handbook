...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_180/` | SRR32633351 |
...
- SRA run: [SRR32633351](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633351) (sample alias `COL180`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_180/`
