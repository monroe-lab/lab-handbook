...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_547/` | SRR32633508 |
...
- SRA run: [SRR32633508](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633508) (sample alias `COL547`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_547/`
