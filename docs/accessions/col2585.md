...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2585/` | SRR32633427 |
...
- SRA run: [SRR32633427](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633427) (sample alias `COL2585`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2585/`
