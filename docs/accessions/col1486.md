...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1486/` | SRR32633560 |
...
- SRA run: [SRR32633560](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633560) (sample alias `COL1486`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1486/`
