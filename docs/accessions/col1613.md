...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1613/` | SRR32633366 |
...
- SRA run: [SRR32633366](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633366) (sample alias `COL1613`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1613/`
