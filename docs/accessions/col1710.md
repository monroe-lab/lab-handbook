...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1710/` | SRR32633358 |
...
- SRA run: [SRR32633358](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633358) (sample alias `COL1710`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1710/`
