...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1231/` | SRR32633195 |
...
- SRA run: [SRR32633195](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633195) (sample alias `COL1231`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1231/`
