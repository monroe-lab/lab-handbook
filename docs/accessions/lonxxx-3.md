...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/LONXXX_3/` | SRR32633567 |
...
- SRA run: [SRR32633567](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633567) (sample alias `LONXXX-3`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/LONXXX_3/`
