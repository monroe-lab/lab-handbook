...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2489/` | SRR32633435 |
...
- SRA run: [SRR32633435](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633435) (sample alias `COL2489`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2489/`
