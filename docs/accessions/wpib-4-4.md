...
type: "accession"
title: "WPIB_4_4"
accession_id: "WPIB_4_4"
project: "Pistachio Wolfskill Collection"
people: "[[Patrick J Brown]]"
species: "Pistacia vera"
status: "completed"
status_note: "Illumina WGS at Wolfskill (Brown lab); not retained in the 774-sample GBS panel. Legacy WGS ID `DPIS46`."
priority: "1"
...
*Pistacia vera* accession from [[Patrick J Brown]]'s diversity collection at the UC Davis Wolfskill Experimental Orchard (Winters, CA). Wolfskill orchard block B, row 4, tree 4.
...
| --- | --- | --- |
| Illumina WGS | `Pvera_Kerman_RefGen_v1` | `/group/gmonroegrp2/chaehee/pistachio/wgs_wolfskill/` (legacy sample ID `DPIS46`) |
...
- Legacy WGS sample ID: `DPIS46` (in `mapping_sampleID.txt`)
