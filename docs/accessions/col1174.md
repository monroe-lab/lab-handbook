...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1174/` | SRR32633536 |
...
- SRA run: [SRR32633536](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633536) (sample alias `COL1174`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1174/`
