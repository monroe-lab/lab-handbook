...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1399/` | SRR32633376 |
...
- SRA run: [SRR32633376](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633376) (sample alias `COL1399`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1399/`
