...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1142B/` | SRR32633335 |
...
- SRA run: [SRR32633335](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633335) (sample alias `COL1142B`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1142B/`
