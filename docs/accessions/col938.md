...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_938/` | SRR32633320 |
...
- SRA run: [SRR32633320](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633320) (sample alias `COL938`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_938/`
