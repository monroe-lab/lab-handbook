...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2062/` | SRR32633460 |
...
- SRA run: [SRR32633460](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633460) (sample alias `COL2062`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2062/`
