...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ORBXXX_14/` | SRR32633188 |
...
- SRA run: [SRR32633188](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633188) (sample alias `ORBXXX-14`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ORBXXX_14/`
