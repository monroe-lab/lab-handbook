...
status: "completed"
status_note: "Illumina WGS at Wolfskill (Brown lab); not retained in the 774-sample GBS panel. Legacy WGS ID `DPIS129`."
priority: "1"
...
| --- | --- | --- |
| Illumina WGS | `Pvera_Kerman_RefGen_v1` | `/group/gmonroegrp2/chaehee/pistachio/wgs_wolfskill/` (legacy sample ID `DPIS129`) |
...
- Legacy WGS sample ID: `DPIS129` (in `mapping_sampleID.txt`)
