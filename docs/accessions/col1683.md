...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1683/` | SRR32633362 |
...
- SRA run: [SRR32633362](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633362) (sample alias `COL1683`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/col_1683/`
