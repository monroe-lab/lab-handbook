...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_52A/` | SRR32633228 |
...
- SRA run: [SRR32633228](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633228) (sample alias `COL52A`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_52A/`
