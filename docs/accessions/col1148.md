...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1148/` | SRR32633233 |
...
- SRA run: [SRR32633233](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633233) (sample alias `COL1148`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1148/`
