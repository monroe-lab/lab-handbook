...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1535/` | SRR32633212 |
...
- SRA run: [SRR32633212](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633212) (sample alias `COL1535`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1535/`
