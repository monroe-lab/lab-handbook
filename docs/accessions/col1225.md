...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1225/` | SRR32633311 |
...
- SRA run: [SRR32633311](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633311) (sample alias `COL1225`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_1225/`
