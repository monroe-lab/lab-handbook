...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_933/` | SRR32633321 |
...
- SRA run: [SRR32633321](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633321) (sample alias `COL933`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_933/`
