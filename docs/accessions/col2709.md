...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL2709/` | SRR32633340 |
...
- SRA run: [SRR32633340](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633340) (sample alias `COL2709`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL2709/`
