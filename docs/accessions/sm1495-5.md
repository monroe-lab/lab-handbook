...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/SM_1495_5/` | SRR32633392 |
...
- SRA run: [SRR32633392](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633392) (sample alias `SM1495-5`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/SM_1495_5/`
