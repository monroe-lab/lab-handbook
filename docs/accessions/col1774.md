...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1774/` | SRR32633200 |
...
- SRA run: [SRR32633200](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633200) (sample alias `COL1774`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1774/`
