...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_378/` | SRR32633238 |
...
- SRA run: [SRR32633238](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633238) (sample alias `COL378`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_378/`
