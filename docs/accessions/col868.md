...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_868/` | SRR32633533 |
...
- SRA run: [SRR32633533](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633533) (sample alias `COL868`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_868/`
