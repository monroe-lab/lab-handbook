...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_480/` | SRR32633512 |
...
- SRA run: [SRR32633512](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633512) (sample alias `COL480`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_480/`
