...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2034/` | SRR32633463 |
...
- SRA run: [SRR32633463](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633463) (sample alias `COL2034`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2034/`
