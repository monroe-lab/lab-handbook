...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1478/` | SRR32633562 |
...
- SRA run: [SRR32633562](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633562) (sample alias `COL1478`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1478/`
