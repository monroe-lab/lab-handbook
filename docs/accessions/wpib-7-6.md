...
*Pistacia vera* accession from Pat Brown's diversity collection at the UC Davis Wolfskill Experimental Orchard (Winters, CA). Wolfskill orchard block B, row 7, tree 6.
