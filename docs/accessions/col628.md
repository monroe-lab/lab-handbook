...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_628/` | SRR32633276 |
...
- SRA run: [SRR32633276](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633276) (sample alias `COL628`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_628/`
