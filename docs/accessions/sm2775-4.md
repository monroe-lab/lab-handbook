...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/SM_2775_4/` | SRR32633386 |
...
- SRA run: [SRR32633386](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633386) (sample alias `SM2775-4`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/SM_2775_4/`
