...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_275/` | SRR32633337 |
...
- SRA run: [SRR32633337](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633337) (sample alias `COL275`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_275/`
