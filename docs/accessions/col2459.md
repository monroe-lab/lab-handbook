...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2459/` | SRR32633439 |
...
- SRA run: [SRR32633439](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633439) (sample alias `COL2459`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2459/`
