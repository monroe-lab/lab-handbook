...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL1417/` | SRR32633472 |
...
- SRA run: [SRR32633472](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633472) (sample alias `COL1417`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL1417/`
