...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_122/` | SRR32633206 |
...
- SRA run: [SRR32633206](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633206) (sample alias `COL122`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_122/`
