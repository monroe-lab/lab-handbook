...
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ORBXXX_1/` | SRR32633497 |
...
- SRA run: [SRR32633497](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633497) (sample alias `ORBXXX-1`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ORBXXX_1/`
