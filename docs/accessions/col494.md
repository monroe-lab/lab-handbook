...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_494/` | SRR32633231 |
...
- SRA run: [SRR32633231](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633231) (sample alias `COL494`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/Col_494/`
