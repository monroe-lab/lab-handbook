...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1069/` | SRR32633552 |
...
- SRA run: [SRR32633552](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633552) (sample alias `COL1069`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_1069/`
