...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_123/` | SRR32633384 |
...
- SRA run: [SRR32633384](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633384) (sample alias `COL123`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_123/`
