...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_133/` | SRR32633296 |
...
- SRA run: [SRR32633296](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633296) (sample alias `COL133`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_133/`
