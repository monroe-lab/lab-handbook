...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_456/` | SRR32633232 |
...
- SRA run: [SRR32633232](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633232) (sample alias `COL456`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_456/`
