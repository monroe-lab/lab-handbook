...
*Manihot alutacea* (a wild relative of cassava) sequenced for [[Kehan Zhao]]'s 2026 *New Phytologist* paper on Colombian cassava landrace genomic diversity. Wild *Manihot* sample. Directory uses placeholder species code; SRA species: *Manihot alutacea*.

## Sequencing

| Platform | Run / batch | Farm path | SRA |
| --- | --- | --- | --- |
| Illumina WGS | Batch 4 (BGI, BRT_F21FTSUSAT1347-03_MANcapxR) | `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ALTXXX_9/` | SRR32633247 |
...
- SRA run: [SRR32633247](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633247) (sample alias `ALTXXX-9`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_4.tar.gz` → `soapnuke/clean/ALTXXX_9/`
