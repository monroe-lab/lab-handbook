...
| --- | --- | --- | --- |
| Illumina WGS | Batch 2n3 (BGI, BRT_F21FTSUSAT1347_PLAhnfuR) | `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_526/` | SRR32633294 |
...
- SRA run: [SRR32633294](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633294) (sample alias `COL526`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_2n3.tar.gz` → `clean/COL_526/`
