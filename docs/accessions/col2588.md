...
| --- | --- | --- | --- |
| Illumina WGS | Batch 1 (BGI, BRT_F21FTSUSAT1347_PLApeuiR) | `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2588/` | SRR32633426 |
...
- SRA run: [SRR32633426](https://www.ncbi.nlm.nih.gov/sra/?term=SRR32633426) (sample alias `COL2588`)
- Farm raw reads: `/group/gmonroegrp3/cassava/Batch_1.tar.gz` → `clean/COL_2588/`
