...
70 µm strainer used for the **coarse filtration step** in nuclei isolation, ahead of the fine
...
> a replacement — a 70 µm strainer from a different vendor is likely fine, but the handbook
> should record what the lab uses.]`
